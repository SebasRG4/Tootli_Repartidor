...
class ApiClient extends GetxService {
  ...
  Future<Response> getData(
    ...
    try {
      print('====> [ApiClient] getData: $uri');
      final String fullUrl = uri.startsWith('http') ? uri : appBaseUrl + uri;
      print('====> [ApiClient] fullUrl: $fullUrl');
  ...
  Future<Response> postData(
    ...
    try {
      ...
      http.Response response = await http
          .post(
            Uri.parse(uri.startsWith('http') ? uri : appBaseUrl + uri),
